...
class TutorialGameBoard extends StatefulWidget{
  ...
  TutorialGameBoard({Key key, @required this.onPointChanged, this.onCompleted, this.playCount, this.stopped}) : super(key: key);

  @override
  _TutorialGameBoardState createState() => _TutorialGameBoardState();
}


class _TutorialGameBoardState extends State<TutorialGameBoard> {
  ...
  void didUpdateWidget(TutorialGameBoard oldWidget){
